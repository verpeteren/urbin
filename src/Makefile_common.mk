...
DIRS = $(DIR_PICOEV) $(DIR_H3) $(DIR_CLOG) $(DIR_TADL) $(DIR_ONIG) $(DIR_PG) $(DIR_MOZ) $(DIR_NSPR) $(DIR_CONF) $(DIR_Z) $(DIR_DST) $(DIR_URL)
INCS = $(INC_PICOEV) $(INC_H3) $(INC_CLOG) $(INC_TADL) $(INC_ONIG) $(INC_PG) $(INC_MOZ) $(INC_NSPR) $(INC_CONF) $(INC_Z) $(INC_URL)
ifeq ($(MAKE_STATIC_LIBS),yes)
DEPS = $(LIB_PICOEV_STATIC) $(LIB_H3_STATIC) $(LIB_CLOG_STATIC) $(LIB_TADL_STATIC) $(LIB_ONIG_STATIC) $(LIB_PG_STATIC) $(LIB_MOZ_STATIC) $(LIB_NSPR_STATIC) $(LIB_CONF_STATIC) $(LIB_Z_STATIC) $(LIB_URL_STATIC)
LIBS = $(LIB_PICOEV_STATIC) $(LIB_H3_STATIC) $(LIB_CLOG_STATIC) $(LIB_TADL_STATIC) $(LIB_ONIG_STATIC) $(LIB_PG_STATIC) $(LIB_MOZ_STATIC) $(LIB_NSPR_STATIC) $(LIB_CONF_STATIC) $(LIB_Z_STATIC) $(LIB_URL_STATIC)
else
DEPS = $(LIB_PICOEV_SHARED) $(LIB_H3_SHARED) $(LIB_CLOG_SHARED) $(LIB_TADL_SHARED) $(LIB_ONIG_SHARED) $(LIB_PG_SHARED) $(LIB_MOZ_SHARED) $(LIB_NSPR_SHARED) $(LIB_CONF_SHARED) $(LIB_Z_SHARED) $(LIB_URL_SHARED)
