...
#define PR_CFG_CORE_RUN_AS_GROUP					"daemon"					//  cfg:  main/run_as_group
#define PR_CFG_CORE_TIMEOUT_SEC						60							//  cfg:  main/timeout_sec
#define PR_CFG_CORE_TICKS_MS						50							//  cfg:  main/ticks_ms
#define PR_CFG_CORE_MAX_WAIT						10							//  cfg:  main/max_wait
#define PR_CFG_CORE_DAEMON							cfg_false					//  cfg:  main/daemon
#define PR_CFG_CORE_LOG_LEVEL_TEXT					"info"						//	cfg:  main/log_level
