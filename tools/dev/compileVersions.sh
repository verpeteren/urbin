...
function whitespace {
	...
	grep -n " ;" */*
	grep -n "[^ \t]=" */*|grep -v "=="|grep -v "!="|grep -v "+="|grep -v "=%"|grep -v ">="|grep -v "\-="|grep -v "<="
	grep -n "=[^ \t]" */*|grep -v "=="|grep -v "!="|grep -v "+="|grep -v "=%"|grep -v ">="|grep -v "\-="|grep -v "<="
	grep -n free */*|grep -v NULL|grep -v Core_Log|grep -v onig_region_free
	grep -in "fixme" */*|grep -v "//  @FIXME:  "
	grep -in "todo" */*|grep -v "//  @TODO:  "
}
